...
## 1. The problem that prompted this
...
- **TSF-DEF-1** - Core Definitions (the vocabulary that names what the origin narrative describes)
...
TSF-NAR-3 records the origin of TrustSurface: a response to the recurring pattern of organisations suffering visible, preventable trust failures at the digital edge while lacking the vocabulary, ownership model, and operating rhythm to govern and improve their trust posture.
